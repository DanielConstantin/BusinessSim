...
static public void createEvList(){
 ...
 plyEvents ev1 = new plyEvents(0, "Competitors", false,"Your major competitor implement a TV Spot that afect your sales. Finance: -4000$, Credibility: -3, Motivation: -5.",-4000, -3, -5);
 ...
 plyEvents ev5 = new plyEvents(0, "Free Advertising",true, "A famous person promotes your product at an important gala. Finance: +3000$, Credibility: +4, Motivation: +3.", +3000, +4, +3);
 plyEvents ev6 = new plyEvents(0, "Autorities", false,"You got a fine. Finance: -3000$, Credibility: -1, Motivation: -1.",-3000, -1, -1);
 plyEvents ev7 = new plyEvents(0, "Products", false,"The sales of the main product dropped down. Finance: -3000, Credibility: -3, Motivation: -2.",-3000, -3, -2);
 ...
 plyEvents ev10= new plyEvents(0, "Authorities",false,"After an investigation you have to pay because you forgot to pay some bills. Finance: -2000$, Credibility: -1, Motivation: -2.",-2000,-1,-2);
 ...
 plyEvents ev12= new plyEvents(0, "Human Error",false,"You've lost some papers, you have to make new ones. Finance: -1500$, Credibility: -0, Motivation: -2.",-1500,-0,-2);
 ...
 plyEvents ev15= new plyEvents(0, "Autorities",false,"You paid your taxes late, therefore athe authorities sanctioned you. Finance: -1500$, Credibility: -1, Motivation: -2.",-1500,-1,-2);
 ...
 plyEvents ev17= new plyEvents(0, "Clients", false, "One of your servers crushed. You need to replace it and restore the data, that caused some chaos in your deliveries. Finance: -1000$, Credibility: -3, Motivation: -2", -1000, -3, -1);
 plyEvents ev18= new plyEvents(0, "Clients", true, "You made a good job with your last delivery. Your clients are excited about your work. Finance: +3000$, Credibility: +6, Motivation: +5.", +3000, +6, +5);
 plyEvents ev19= new plyEvents(0, "Employees", true, "Your employees have done a good work this week. Finance: +1900$, Credibility +3, Motivation: +4.", +1900, +3, +4);
 plyEvents ev20= new plyEvents(0, "Products", true, "Some investors are attracted to your products, there will be some collaborations between you that will benefit you. Finance: +4000, Credibility: +3, Motivation:+4.", +4000, +3, +4);
 plyEvents ev21= new plyEvents(0, "Free Advertising", true, "Some sponsors have offered to pay you money for a TV commercial. Finance: +1900$, Credibility: +2, Motivation: +1.", +1900, +2, +1);
 plyEvents ev22= new plyEvents(0, "Free Advertising", true, "Some sponsors have offered to pay you money for a radio commercial. Finance: +1700$, Credibility: +5, Motivation: +2.", +1700, +5, +2);
 plyEvents ev23= new plyEvents(0, "Lucky", true, "You received the new equipment gift. Credibility: +3, Motivation: +4.", +0, +3, +4);
 ...
 plyEvents ev25= new plyEvents(0, "Lucky", true, "Netflix has given you an opportunity to work together. Finance: +4000$, Credibility: +3, Motivation: +4.", +4000, +3, +4);
 ...
 plyEvents ev29= new plyEvents(0, "Free Advertising", true, "Gelena Somez tweeted and said she likes your products. Finance: +3000$, Credibility: +2, Motivation: +4.", +3000, +2, +4);
 plyEvents ev30= new plyEvents(0, "Clients", false, "Gelena Somez tweeted and said she doen't like your products. Finance: -3000$, Credibility: -2, Motivation: -4.", -3000, -2, -4);
 eventList.add(ev0);
 eventList.add(ev1); 
 eventList.add(ev2);
 eventList.add(ev3);
