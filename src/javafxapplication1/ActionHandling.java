...
static public void createEvList(){
 ...
 plyEvents ev17= new plyEvents(0, "Clients", false, "One of your servers crushed. You need to replace it and restore the data, that caused some chaos in your deliveries. Finance: -1000$, Credibility -3, People -2", -1000, -3, -1);
 plyEvents ev18= new plyEvents(0, "Clients", true, "You made a good job with your last delivery. Your clients are excited about your work. Finance: +3000$, Credibility: +15, Motivation: +5.", +3000, +15, +5);
 plyEvents ev19= new plyEvents(0, "Employees", true, "Your employees have done a good work this week. Finance: +1900$, Credibility +30, People +40", +1900, +30, +40);
 plyEvents ev20= new plyEvents(0, "Products", true, "Some investors are attracted to your products, there will be some collaborations between you that will benefit you. Finance: +4000, Credibility +30, People +14", +4000, +30, +14);
 plyEvents ev21= new plyEvents(0, "Free Advertising", true, "Some sponsors have offered to pay you money for a TV commercial. Finance: +1900$, Credibility +20, People +10", +1900, +20, +10);
 plyEvents ev22= new plyEvents(0, "Free Advertising", true, "Some sponsors have offered to pay you money for a radio commercial. Finance: +1700$, Credibility +15, People +20", +1700, +15, +20);
 plyEvents ev23= new plyEvents(0, "Lucky", true, "You received the new equipment gift. Credibility +30, People +40", +0, +30, +40);
 plyEvents ev24= new plyEvents(0, "Employees", true, "Your business accountant is becoming more and more skillful. Finance: +1000$, Credibility +1, People +4", +1000, +1, +4);
 plyEvents ev25= new plyEvents(0, "Lucky", true, "Netflix has given you an opportunity to work togetherFinance: +4000$, Credibility +30, People +40", +4000, +30, +40);
 plyEvents ev26= new plyEvents(0, "Free Advertising", true, "A documentary about your business has been made. Finance: +1500$, Credibility +30, People +40", +1500, +30, +40);
 plyEvents ev27= new plyEvents(0, "Free Advertising", true, "Micky Ninaj tweeted and said she likes your products. Finance: +3000$, Credibility +20, People +4", +3000, +20, +4);
 plyEvents ev28= new plyEvents(0, "Clients", false, "Micky Ninaj tweeted and said she doen't like your products. Finance: -3000$, Credibility -20, People -4", -3000, -20, -4);
 plyEvents ev29= new plyEvents(0, "Free Advertising", true, "Gelena Somez tweeted and said she likes your products. Finance: +3000$, Credibility +20, People +4", +3000, +20, +4);
 plyEvents ev30= new plyEvents(0, "Clients", false, "Gelena Somez tweeted and said she doen't like your products. Finance: -3000$, Credibility -20, People -4", -3000, -20, -4);
 eventList.add(ev0);
 eventList.add(ev1); 
 eventList.add(ev2);
 eventList.add(ev3);
