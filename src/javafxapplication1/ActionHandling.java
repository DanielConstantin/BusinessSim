...
static public void createEvList(){
 ...
 plyEvents ev1 = new plyEvents(0, "Competitors", false,"Your major competitor implement a TV Spot that afect your sales. Finance: -4000$, Credibility: -3, Motivation: -9.",-4000, -3, -9);
 ...
 plyEvents ev25= new plyEvents(0, "Lucky", true, "Netflix has given you an opportunity to develop a project together. Finance: +2000$, Credibility: +10, Motivation: +5.", +2000, +10, +5);
 ...
 plyEvents ev30= new plyEvents(0, "Clients", false, "A TV news mention one of your products in a bad context, your sales droped. Finance: -3000$, Credibility: -6, Motivation: -5.", -3000, -2, -4);
 eventList.add(ev0);
 eventList.add(ev1); 
 eventList.add(ev2);
 eventList.add(ev3);
